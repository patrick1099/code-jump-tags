...
const COMMANDS = [
  ...
  },
  {
    ...
    insertText: new vscode.SnippetString('codeJumpTags.sendTextToTerminal?["')
  ...
  },
  {
    ...
    insertText: new vscode.SnippetString('codeJumpTags.startTourByTitle?["')
